...
class Date( object ):
    ...
    def __str__( self ):
        ...
        out_str = "{:02d}/{:02d}/{:04d}".format( self.__month, self.__day, self.__year )
    ...
    def __validate( self ):
        ...
        if (1 <= self.__month <= 12) and (1 <= self.__day <= Date.__days[self.__month] ) and (0 <= self.__year):
    ...
    def to_iso( self ):
        ...
        iso_str = "{:04d}-{:02d}-{:02d}".format( self.__year, self.__month, self.__day )
    ...
    def to_mdy( self ):
        ...
        mdy_str = "{:s} {:d}, {:04d}".format( Date.__name[self.__month], self.__day, self.__year )
